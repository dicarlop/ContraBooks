...
export default {
  ...
  data(){return{period:'This Year',companyName:'',recentInvoices:[] as InvoiceRow[],topCustomers:[] as RankRow[],topProducts:[] as RankRow[]};},
  computed:{
