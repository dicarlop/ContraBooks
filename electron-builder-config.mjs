export default {
  ...
  directories: { app: 'dist_electron/build', output: 'dist_electron', buildResources: 'build' },
  ...
  mac: { category: 'public.app-category.finance', target: ['dmg','zip'], icon: 'build/icon.icns' },
  linux: { target: ['AppImage','deb'], category: 'Office', icon: 'build/icon.png' },
};
